...
static void wifi_init_softap(void)
{
    ...
    ESP_LOGI(TAG, "SoftAP 启动成功！SSID:%s 密码:%s", ESP_WIFI_SSID, ESP_WIFI_PASS);
    ESP_LOGI(TAG, "请用手机连接该热点，并在浏览器或测试工具访问 ws://192.168.4.1/ws");
}
...
void app_main(void)
{
    ...
    // 删除或注释掉官方的 ESP_ERROR_CHECK(example_connect());
    // 删除或注释掉官方注册 IP_EVENT 等乱七八糟的回调函数
